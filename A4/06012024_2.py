"""
epsilon Qlearning implementation (not working)
"""
...
class QLearningAgent:
    ...
    """
    def __init__(self, maze, discount_factor=0.9, max_iters=1000, alpha=0.2, epsilon=0.1, epsilon_decay=0.95, epsilon_min=0.01):
    ...
    def rl_epsilon_q_learning(self, episodes):
        """
        Performs Reinforcement Learning using an epsilon-greedy Q-learning algorithm.
        It iterates over a specified number of episodes to improve the policy.
        """
        self.reset_q_values()  # Reset Q-values before starting RL

        # Visualization: Q-values at the beginning of training
        self.visualize_rl_training(0)
        ...
        for episode in range(episodes):
            ...
            while not done:
                ...
                if new_state is None:
                    ...
                    self.maze.state = new_state  # Update the current state
                # Visualization: Print Q-values at specified intervals and at the end
            if episode < 5 or episode % 20 == 0 or episode == episodes - 1:
                self.visualize_rl_training(episode + 1)

        # Visualization: Final policy and Q-values after training is complete
